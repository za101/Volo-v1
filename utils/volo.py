...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None,
                 out_features=None, act_layer=nn.SiLU,
                 drop=0.):
        super().__init__()
...
class VOLO(nn.Module):
    ...
    """
    def __init__(self, layers, img_size=32, in_chans=3, num_classes=100, patch_size=8,
...
# return_dense and mix_token change from True to False
